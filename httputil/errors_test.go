...
func TestErrorHandler(t *testing.T) {
	...
	tests := []struct {
		...
		{"json error", context.Background(), json.Unmarshal([]byte("bad json"), &nop), "", 400, `"invalid character 'b' looking for beginning of value at offset 1"`, "invalid character 'b' looking for beginning of value"},
